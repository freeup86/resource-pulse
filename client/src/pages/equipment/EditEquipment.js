...
const EditEquipment = () => {
  ...
  const fetchEquipmentData = async () => {
    try {
      ...
      setFormData({
        ...equipmentData,
        acquisitionDate: equipmentData.acquisitionDate ? new Date(equipmentData.acquisitionDate) : null,
        warrantyExpiration: equipmentData.warrantyExpiration ? new Date(equipmentData.warrantyExpiration) : null
      });
